...
//        initComponents();
    ...
    private void CaptureImage(JLabel image) {
        try {
            stopCam();
            if (getImage != null) {
                ImageIcon imageicon = new ImageIcon(new ImageIcon(Filename).getImage().getScaledInstance(Admin.jLabel8.getWidth(),
                        Admin.jLabel8.getHeight(), Image.SCALE_DEFAULT));
                Admin.jLabel8.setIcon(imageicon);
            }
        } catch (Exception e) {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if (option == 0) {
            try {
                ...
                Admin.jTextField1.setText(Filename);
